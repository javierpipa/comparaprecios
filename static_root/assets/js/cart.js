            ...
            function fill_card_pedido(data, divid) {
                ...
                $.each(data, function (i, item) {
                    var trHTML = '';
                    // var url         = "{% url 'precios:detalle' 123 %}";
                                        ...
                                        '<div class="col">'+
                                            '<div class="card">' +
                                                '<div class="card-header">' +
                                                    ...
                                                    '</div>' +
                                                '</div>' +
                                                '<img src="' + item.imagen +  '" class="card-img-top img-thumbnail rounded" alt="' + item.nombre + '" />' +
                                                '<div class="card-body">' +
                                                    '<div class="float-start">' +
                    ...
                    // <div class="w-100" > +
                    // '</div>';
                    // '<div class="form-outline" style="border-style: dotted">' +
                    // '</div>' +
                    // bottones de cantidad
            ...
            function echoinfo(data,  detalle) {
                ...
                $.each(data, function (i, suoer) {
                    ...
                    if (Number(suoer.totcompra) > Number(suoer.monto_minimo_compra)) {
                        ...
                        nota = "no alcanza compra minima";
                        nota_titulo = "Compra minima";
                    ...
                    resumen = '<div class="card-body">'+
                                ...
                                '<li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3">' +
                                    ...
                                    '<span><strong>'  + formatter.format(suoer.supermercados.areaDespacho_valor_despacho + suoer.totcompra) + '</strong></span></li></ul>'  +
                    ...
                    linea_03    = '<div class="accordion-item ">'+
                                        '<h2 class="accordion-header" id="super_'  +  suoer.supermercados.areaDespacho_despachoid  +'">'  +
                                            '<button class="accordion-button  ' +  clase +  '" type="button" data-bs-toggle="collapse" data-bs-target="#collapse' + suoer.supermercados.areaDespacho_despachoid  +'" aria-expanded="' +  expanded  +'" aria-controls="collapseOne">' +
                                                ...
                                                ' <span class="badge badge-primary rounded-pill">' + formatter.format(suoer.supermercados.areaDespacho_valor_despacho + suoer.totcompra) + '</span>' +
                                            '</button>' +
                                        '</h2>' +
                                        '<div id="collapse' + suoer.supermercados.areaDespacho_despachoid +  '" class="accordion-collapse collapse ' + expanded_class + '" aria-labelledby="super_'  + suoer.areaDespacho_despachoid +  '" data-bs-parent="#accordionSuper">' +
                                            '<div class="accordion-body">' +
                                                '<p>'  +
                                                    '<i class="bi bi bi-exclamation-diamond" title="Minimo de compra"></i> ' +  formatter.format(suoer.supermercados.areaDespacho_monto_minimo_compra) +  ' ' +
            ...
            function carritoinfo(superdetail) {
                ...
                // $("#botonlista").attr({'title': superdetail.lista.nombre});
                // $("#nombre_lista").val(superdetail.lista.nombre);
            };
