...
class OBJETOS_EN_PLAN(models.TextChoices):
    ...
    COMUNAS           = "Comunas de despacho de un país."
...
class Plan(models.Model):
    ...
    icono           = models.CharField(max_length=100, blank=True, null=True, help_text='Nombre del plan')
...
class Member(models.Model):
    ...
    direccion   = models.CharField(max_length=250, blank=True, null=True, help_text='Direccion')
    comuna      = models.ForeignKey(to='precios.Cities', on_delete=models.PROTECT, blank=True, null=True)
    account2    = models.ForeignKey(Account, on_delete=models.PROTECT, blank=True, null=True, default=4)

    class Meta:
        unique_together = [['user', 'account2']]
...
class Lista(models.Model):
    ...
    privada         = models.BooleanField('This list can be viewed by others', default=True)
